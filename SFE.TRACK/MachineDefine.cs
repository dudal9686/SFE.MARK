...
/// This file is generated by MachineMaster(1.1.0.4)
/// This file is generated at 2026-02-20 17:02
...
namespace MachineDefine
{
   ...
   public enum EnumCommand_Action {
      ...
      Chamber__StepRequest,  // Chamber:BlockNo:ModuleNo:(Idle, PutReady, Processing, GetReady):JobName:SystemRecipe
                                // MCS->Chamber
      ...
      MaintChamber__MaintIO,  // Chamber:BlockNo:ModuleNo:IOIndex:1/0
      MaintChamber__MoveArm,  // Chamber:BlockNo:ModuleNo:AxisName:Position
      MaintChamber__PumpRecipeListRequest,
      MaintChamber__PumpRecipeDetailRequest,  // PumpRecipe
      MaintChamber__DummyDispenseAction,  // Maint:BlockNo:ModuleNo:DispNo:Time(count):Recipe
      MaintChamber__StepControlMode,  // Maint:BlockNo:ModuleNo:0/1
      MaintChamber__StepControlNextStep,  // Maint:BlockNo:ModuleNo:TRUE/FALSE
      MaintChamber__StepControlRepeatStep,  // Maint:BlockNo:ModuleNo:TRUE/FALSE
      MaintChamber__StepControlAction,  // Maint:BlockNo:ModuleNo:TRUE/FALSE
      Chamber__OriginStop,
   };
   ...
   public enum EnumCommand_Setting {
      ...
      MCS__WorkStop,  // (Stop, Cancel)
                         // Stop은 더이상 집어 넣지 않고 진행되던 Wafer는 다 진행하고 끝남
                         // Cancel은 진행되던 Recipe까지만 하고 배출
      MCS__WaferClear,
      Wafer__Delete,  // Kind(PRA, CRA, Chamber, Developer, Coater)
                         // Index
                         // 
                         // PRA:0
   };
   ...
   public enum EnumCommand_Status {
      ...
      Chamber__Information,  // Chamber:BlockNo:ModuleNo:(Idle, IdleDone, PutReady, PutReadyDone, Processing, ProcessingDone, GetReady, GetReadyDone, Alarm)
                                // 
                                // Chamber->MCS
                                // 
                                // Mcs가 PutReady를 주면 ready후 PutReadyDone으로 변경
                                ...
                                // Chamber:BlockNo:ModuleNo:ProcessingDone:(Cancel,Delete)
                                // 
      ...
      MCS__ActorWorkStep,
      MCS__Notify,
      MaintChamber__MaintIORequest,  // Chamber:BlockNo:ModuleNo:IOType:Result(0/1):State(onoff)
      MCS__TowerLamp,
      MaintChamber__MaintMoveArmResult,  // Chamber:BlockNo:ModuleNo:AxisName:Result(0/1)
      MaintChamber__PumpRecipeResponse,
      MaintChamber__PumpRecipeDetailResponse,  // recipeName:dispAmount:dispRate:acc:dec:reloadRate:cal:acCloseDelay
      MaintChamber__DummyDispenseResult,  // Maint:BlockNo:ModuleNo:DispNo:Result(0/1)
      MaintChamber__StepControlState,  // Maint:BlockNo:ModuleNo:Recipe:CrrentStep:UnitState:StepTime:Dispense:RPM
      DATA__MonitoringData,  // BlockNo ModuleNo Type Zone SV PV:BlockNo ModuleNo Zone Type SV PV
      Chamber__RequestAck,  // Chamber->MCS
                               // 
                               // Action : Chamber_StepRequest
   };
   ...
   public enum EnumPrgCfg {
      Environment__Operation,  // EnumOperationMode (0:RealRun, 1:DryRun, 2:DryRunWithoutChamber)
      Environment__TowerLamp,  // O(On) X(OFF) T(Toggle)
                                  // RYGB(red,yellow,green,buzzer)
      Environment__ChamberInfo,  // 첫번째 부터 차례대로 정의
                                    // Index, Type, BlockNo, ModuleNo, Use(true/false), Maint(0:None, 1:Maint, 2:MaintUse)
                                    // 사용하지 않으면 띄우기
      Environment__CoaterInfo,  // Index, BlockNo, ModuleNo, Use(true/false), Maint(0:None, 1:Maint, 2:MaintUse)
      Environment__DeveloperInfo,  // Index, BlockNo, ModuleNo, Use(true/false), Maint(0:None, 1:Maint, 2:MaintUse)
      ...
      Environment__ChamberLiquidOperation,
      Environment__ChamberTempOperation,
      Lot__Job,  // 1,WAFER_FLOW_RECIPE,WAFER_FLOW_RECIPE,WAFER_FLOW_RECIPE,WAFER_FLOW_RECIPE,WAFER_FLOW_RECIPE,WAFER_FLOW_RECIPE,
                    ...
                    // 
      Lot__LotInfo,
      MachineOption__WaferProcessMode,
      MachineOption__ZOffsetCRA,  // Teaching z 위치에서 얼마나 이동해서 작업 할지 결졍 된다.
                                     // Lower offset은 get하러 들어갈때 put 시 나올때 적용 된다.
                                     // Upper offset은 put시 들어갈때 get시 나올때 적용된다.
      MachineOption__ZOffsetPRA,  // Teaching z 위치에서 얼마나 이동해서 작업 할지 결졍 된다.
                                     // Lower offset은 get하러 들어갈때 put 시 나올때 적용 된다.
                                     // Upper offset은 put시 들어갈때 get시 나올때 적용된다.
      ...
      SystemChamber__Dev_DispTime,  // 2
      SystemChamber__Cot_Dispense_Flag,
      SystemChamber__Dev_Dispense_Flag,
      ...
      SystemChamber__Dev_Rinse_DispTime,
      SystemChamber__Dev_BackRinse_DispTime,
      SystemChamber__Cot_Bath_IntervalTime,
      SystemChamber__Cot_Bath_OperationTime,
      SystemChamber__Cot_Bath_Sel_NozzleNo,
      SystemChamber__DummyDispProcessWaferCnt,
      SystemChamber__DummyDispProcessTime,
   };
...
public class DefSFETrack
{
   ...
   public enum EnumInput {
      ...
      ChillerMotor2 = 158,
      ChillerMotor3 = 159,
      ChillerHeatingDetectSensor1 = 160,
      ChillerHeatingDetectSensor2 = 161,
      ChillerHeatingDetectSensor3 = 162,
      TCULeakDetectSensor = 163,
      DrainBucketBDetect = 164,
      DrainBucketADetect = 165,
      Solvent_LowLevel_Detect = 166,
      Develop_LowLevel_Detect = 167,
   };
   ...
   public enum EnumOutput {
      ...
      DEV1Rinsevalve = 32, // Board Type(string)
                                                                         ...
                                                                         // Board ID(int)
                                                                         // Index(int)
      DEV1DevelopValve = 33, // Board Type(string)
                                                                           // Channel(int)
                                                                           // Board ID(int)
                                                                           // Index(int)
      ...
      DEV2Rinsevalve = 40, // Board Type(string)
                                                                         ...
                                                                         // Board ID(int)
                                                                         // Index(int)
      DEV2DevelopValve = 41, // Board Type(string)
                                                                           // Channel(int)
                                                                           // Board ID(int)
                                                                           // Index(int)
      ...
      DEV1Safety = 110,
      DEV2Safety = 111,
      ArmPauseCRASWLamp = 112,
      ArmPausePRASWLamp = 113,
      LampBuzzer = 114,
   };
   ...
   public enum EnumManual {
      AssyCRA__DoCheckWaferOnArmJob,  // 1 // int // int storage
      ...
      AssyPRA__DoCheckWaferOnArmJob,  // 1 // int // int armIndex
